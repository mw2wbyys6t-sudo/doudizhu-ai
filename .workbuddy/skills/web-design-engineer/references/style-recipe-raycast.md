...
> **Same school — Modern Tool / Builder SaaS**: [`linear`](./style-recipe-linear.md) · [`vercel-mesh`](./style-recipe-vercel-mesh.md) · [`notion-pre-ai`](./style-recipe-notion-pre-ai.md)  
