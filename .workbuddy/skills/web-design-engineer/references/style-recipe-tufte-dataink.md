...
> **Same school — Information Architecture**: [`pentagram`](./style-recipe-pentagram.md) · [`vignelli-swiss-helvetica`](./style-recipe-vignelli-swiss-helvetica.md) · [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md) · [`nyt-the-daily`](./style-recipe-nyt-the-daily.md)  
