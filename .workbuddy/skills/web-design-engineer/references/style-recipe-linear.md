...
> **Same school — Modern Tool / Builder SaaS**: [`vercel-mesh`](./style-recipe-vercel-mesh.md) · [`raycast`](./style-recipe-raycast.md) · [`notion-pre-ai`](./style-recipe-notion-pre-ai.md)  
