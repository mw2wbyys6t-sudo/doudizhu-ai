...
> **Same school — Editorial / Minimalist**: [`apple-hig`](./style-recipe-apple-hig.md) · [`muji-kenya-hara`](./style-recipe-muji-kenya-hara.md) · [`dieter-rams-braun`](./style-recipe-dieter-rams-braun.md) · [`monocle-magazine`](./style-recipe-monocle-magazine.md)  
