...
> **Same school — Editorial / Minimalist**: [`apple-hig`](./style-recipe-apple-hig.md) · [`aesop`](./style-recipe-aesop.md) · [`dieter-rams-braun`](./style-recipe-dieter-rams-braun.md) · [`monocle-magazine`](./style-recipe-monocle-magazine.md)  
