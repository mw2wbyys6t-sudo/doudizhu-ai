...
```
references/
├── style-recipe-INDEX.md          ← you are here
├── style-recipe-apple-hig.md
├── style-recipe-muji-kenya-hara.md
├── style-recipe-aesop.md
...
| School | Recipes |
|---|---|
| **Editorial / Minimalist** | [`apple-hig`](./style-recipe-apple-hig.md) · [`muji-kenya-hara`](./style-recipe-muji-kenya-hara.md) · [`aesop`](./style-recipe-aesop.md) · [`dieter-rams-braun`](./style-recipe-dieter-rams-braun.md) · [`monocle-magazine`](./style-recipe-monocle-magazine.md) |
| **Information Architecture** | [`pentagram`](./style-recipe-pentagram.md) · [`vignelli-swiss-helvetica`](./style-recipe-vignelli-swiss-helvetica.md) · [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md) · [`tufte-dataink`](./style-recipe-tufte-dataink.md) · [`nyt-the-daily`](./style-recipe-nyt-the-daily.md) |
| **Modern Tool / Builder SaaS** | [`linear`](./style-recipe-linear.md) · [`vercel-mesh`](./style-recipe-vercel-mesh.md) · [`raycast`](./style-recipe-raycast.md) · [`notion-pre-ai`](./style-recipe-notion-pre-ai.md) |
| **Motion / Experimental** | [`field-io`](./style-recipe-field-io.md) · [`active-theory`](./style-recipe-active-theory.md) · [`resn-storytelling`](./style-recipe-resn-storytelling.md) |
| **Brutalist / Raw** | [`are-na`](./style-recipe-are-na.md) · [`bloomberg-businessweek-turley`](./style-recipe-bloomberg-businessweek-turley.md) · [`balenciaga-post-2017`](./style-recipe-balenciaga-post-2017.md) |
| **Warm Humanist** | [`mailchimp-freddie`](./style-recipe-mailchimp-freddie.md) · [`stripe-press`](./style-recipe-stripe-press.md) · [`headspace-meditation`](./style-recipe-headspace-meditation.md) |
| **Specialty / Genre** (not surfaced via Advisor) | [`y2k-retrofuturism`](./style-recipe-y2k-retrofuturism.md) · [`mid-century-modern`](./style-recipe-mid-century-modern.md) |
...
|---|---|
| B2B SaaS / developer tools | [`linear`](./style-recipe-linear.md) · [`vercel-mesh`](./style-recipe-vercel-mesh.md) · [`raycast`](./style-recipe-raycast.md) · [`pentagram`](./style-recipe-pentagram.md) |
| Premium consumer / lifestyle | [`aesop`](./style-recipe-aesop.md) · [`muji-kenya-hara`](./style-recipe-muji-kenya-hara.md) · [`stripe-press`](./style-recipe-stripe-press.md) · [`monocle-magazine`](./style-recipe-monocle-magazine.md) |
| Data product / dashboard / finance | [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md) · [`tufte-dataink`](./style-recipe-tufte-dataink.md) · [`vignelli-swiss-helvetica`](./style-recipe-vignelli-swiss-helvetica.md) |
| Editorial / publishing / longform | [`nyt-the-daily`](./style-recipe-nyt-the-daily.md) · [`monocle-magazine`](./style-recipe-monocle-magazine.md) · [`stripe-press`](./style-recipe-stripe-press.md) · [`mailchimp-freddie`](./style-recipe-mailchimp-freddie.md) |
| Launch moment / brand film / awwwards | [`field-io`](./style-recipe-field-io.md) · [`active-theory`](./style-recipe-active-theory.md) · [`resn-storytelling`](./style-recipe-resn-storytelling.md) · [`vercel-mesh`](./style-recipe-vercel-mesh.md) |
| Differentiated / counter-culture / artist | [`are-na`](./style-recipe-are-na.md) · [`bloomberg-businessweek-turley`](./style-recipe-bloomberg-businessweek-turley.md) · [`balenciaga-post-2017`](./style-recipe-balenciaga-post-2017.md) |
| Approachable B2C / community / health | [`mailchimp-freddie`](./style-recipe-mailchimp-freddie.md) · [`headspace-meditation`](./style-recipe-headspace-meditation.md) · [`notion-pre-ai`](./style-recipe-notion-pre-ai.md) |
| Retro / theme / decade-coded | [`y2k-retrofuturism`](./style-recipe-y2k-retrofuturism.md) · [`mid-century-modern`](./style-recipe-mid-century-modern.md) |

## Index 3 — By Mode (light / dark / either)

| Mode | Recipes |
|---|---|
| Light-first | [`apple-hig`](./style-recipe-apple-hig.md) · [`muji-kenya-hara`](./style-recipe-muji-kenya-hara.md) · [`aesop`](./style-recipe-aesop.md) · [`dieter-rams-braun`](./style-recipe-dieter-rams-braun.md) · [`monocle-magazine`](./style-recipe-monocle-magazine.md) · [`pentagram`](./style-recipe-pentagram.md) · [`nyt-the-daily`](./style-recipe-nyt-the-daily.md) · [`stripe-press`](./style-recipe-stripe-press.md) · [`headspace-meditation`](./style-recipe-headspace-meditation.md) · [`mailchimp-freddie`](./style-recipe-mailchimp-freddie.md) · [`mid-century-modern`](./style-recipe-mid-century-modern.md) |
| Dark-first | [`linear`](./style-recipe-linear.md) · [`vercel-mesh`](./style-recipe-vercel-mesh.md) · [`raycast`](./style-recipe-raycast.md) · [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md) · [`field-io`](./style-recipe-field-io.md) · [`active-theory`](./style-recipe-active-theory.md) · [`resn-storytelling`](./style-recipe-resn-storytelling.md) · [`y2k-retrofuturism`](./style-recipe-y2k-retrofuturism.md) |
| Works either way | [`vignelli-swiss-helvetica`](./style-recipe-vignelli-swiss-helvetica.md) · [`tufte-dataink`](./style-recipe-tufte-dataink.md) · [`notion-pre-ai`](./style-recipe-notion-pre-ai.md) · [`are-na`](./style-recipe-are-na.md) · [`bloomberg-businessweek-turley`](./style-recipe-bloomberg-businessweek-turley.md) · [`balenciaga-post-2017`](./style-recipe-balenciaga-post-2017.md) |
...
Load only the recipe files you actually need. If the user said "Linear-style", read [`linear.md`](./style-recipe-linear.md) — not all 25. The 1-file-at-a-time pattern is what makes this catalog efficient; loading everything up front defeats progressive disclosure.
...
1. **Re-read the user's request** — sometimes the right recipe is obvious in hindsight (a "data-led research tool" is almost always [`tufte-dataink`](./style-recipe-tufte-dataink.md) or [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md), even when the user didn't name those)
