...
> **Same school — Information Architecture**: [`pentagram`](./style-recipe-pentagram.md) · [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md) · [`tufte-dataink`](./style-recipe-tufte-dataink.md) · [`nyt-the-daily`](./style-recipe-nyt-the-daily.md)  
