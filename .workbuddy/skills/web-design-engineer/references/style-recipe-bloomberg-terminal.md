...
> **Same school — Information Architecture**: [`pentagram`](./style-recipe-pentagram.md) · [`vignelli-swiss-helvetica`](./style-recipe-vignelli-swiss-helvetica.md) · [`tufte-dataink`](./style-recipe-tufte-dataink.md) · [`nyt-the-daily`](./style-recipe-nyt-the-daily.md)  
