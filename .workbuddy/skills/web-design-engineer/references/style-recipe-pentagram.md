...
> **Same school — Information Architecture**: [`vignelli-swiss-helvetica`](./style-recipe-vignelli-swiss-helvetica.md) · [`bloomberg-terminal`](./style-recipe-bloomberg-terminal.md) · [`tufte-dataink`](./style-recipe-tufte-dataink.md) · [`nyt-the-daily`](./style-recipe-nyt-the-daily.md)  
